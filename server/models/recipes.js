...
export function paginate(callback) {
...
export function create(recipe, callback) {
    let collection = DB.getDB().collection(COLLECTION),
        doc = {
            name: recipe.name,
            created_on: new Date(),
...
export function addComment(comment, user, callback) {
    let collection = DB.getDB().collection(COLLECTION),
        findQuery = {
            'slug': comment.slug
        },
...
export function editComment(comment, user,  callback) {
    let collection = DB.getDB().collection(COLLECTION),
...
export function deleteComment(args, callback) {
    let collection = DB.getDB().collection(COLLECTION),
